...
# Defaults
DEFAULT_FILE_ID="1ZcMGETfiZ0oalRfafT0M4Y9lvJjD6cdi" 
DEFAULT_BASE_FOLDER_NAME="./HOPE"
DEFAULT_CONDA_ENV_NAME="prj_env"
...
unzip -o valid_npz_outputs.zip -d "$OUTPUT_FOLDER"
