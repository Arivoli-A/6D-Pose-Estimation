...
from engine import train_one_epoch, pose_evaluate
...
dataset_path = '/dataset'  # Path to dataset root
...
dataset_args = {
    ...
    'train_set': train_set,
    'eval_set': eval_set,
    'synt_background': synt_background,
    'n_classes': n_classes,
...
def main():
    ...
    dataset_train = build_dataset(image_set=args.train_set, args=args)  # Modify this to use ours
